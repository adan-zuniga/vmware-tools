...
class PlatformDetails:
    ...
    def get_interface_name(self):
        ...
        """
        # No restart needed on Install-WindowsFeature -Name AD-Domain-Services -IncludeManagementTools;

        # Uninstall-WindowsFeature -Name ADCS-Cert-Authority
        ...
        d = dict(
            ...
            win32=f'{re.sub(pattern=r"{|}", repl="", string=ad_configuration)}'
        )
        # AD-Certificate
        # AD-Domain-Services
        # DNS
